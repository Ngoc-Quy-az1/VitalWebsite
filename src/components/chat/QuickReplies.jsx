export default function QuickReplies({ suggestions, onSelect, disabled }) {
  ...
  return (
    <nav
      ...
      className="mt-3 flex gap-2 overflow-x-auto flex-nowrap w-full pb-1 scrollbar-thin snap-x snap-mandatory mask-gradient justify-start md:justify-center"
    >
